<form method="post" enctype="multipart/form-data" class="sap-form form-horizontal">
	...
	<div class="wrap-list">
		<div class="wrap-group">
			...
			<div class="row">
				<label class="col col-lg-2 control-label" for="username">{lang key='username'}</label>
				<div class="col col-lg-4">
					<input type="text" class="common" placeholder="member_89" name="username" id="block_domain" size="32" value="{if isset($smarty.post.username)}{$smarty.post.username}{/if}">
				</div>
			</div>
			<div class="row">
